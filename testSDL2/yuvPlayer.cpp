...
//  testSDL2
//
//  Created by chengkang on 9/7/20.
...
int testYuv2(int argc, char* argv[]){
    printf("%s",__func__);
    ...
    const int video_width = 1080, video_height = 1920;
//    const int video_width = 2560, video_height = 1600;
//
...
//
    const char *path = "test_yuv420p_1080x1920.yuv";
